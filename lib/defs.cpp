...
std::string & PLINKSeq::ANNOT_ALIAS_GROUPS()    { static std::string s = "_ANNOT_ALIAS_GROUPS"; return s; }
std::string & PLINKSeq::ANNOT_ALIAS_GROUP_WORST()    { static std::string s = "_ANNOT_ALIAS_GROUP_WORST"; return s; }
